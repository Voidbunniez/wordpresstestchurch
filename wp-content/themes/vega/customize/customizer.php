...
function vega_wp_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( 'vega_wp_frontpage_banner', array( 
                                    ...
                                    'type' => 'radio', 
                                    'choices' => array('Image Banner'=>__('Image Banner', 'vega'), 'Full Screen Image'=>__('Full Screen Image', 'vega')),
